...
class Game {
    ...
    renderDebugOverlay() {
        ...
        // Draw controls help
        ctx.textAlign = 'left';
        ctx.fillText('Controls:', 10, this.canvas.height - 70);
        ctx.fillText('Click - Move to tile', 10, this.canvas.height - 50);
        ctx.fillText('Space - Stop moving', 10, this.canvas.height - 30);
        ctx.fillText('P - Pause | R - Reset | Shift+D - Debug', 10, this.canvas.height - 10);
    }
